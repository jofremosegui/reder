...
async function main() {
  ...
  const listings = [
    L(1, {
      ...
      listerName: "Anna (propietària)", listerEmail: "anna.reder+1@example.com", listerPhone: "+34 600 001 001",
    }),
    L(2, {
      ...
      listerName: "Marc", listerEmail: "marc.reder+2@example.com", listerPhone: "+34 600 001 002",
    }),
    L(3, {
      ...
      listerName: "Júlia", listerEmail: "julia.reder+3@example.com", listerPhone: "+34 600 001 003",
    }),
    L(4, {
      ...
      listerName: "Pau", listerEmail: "pau.reder+4@example.com", listerPhone: "+34 600 001 004",
    }),
    L(5, {
      ...
      listerName: "Carla", listerEmail: "carla.reder+5@example.com", listerPhone: "+34 600 001 005",
    }),
    L(6, {
      ...
      listerName: "Oriol", listerEmail: "oriol.reder+6@example.com", listerPhone: "+34 600 001 006",
    }),
    L(7, {
      ...
      listerName: "Laia", listerEmail: "laia.reder+7@example.com", listerPhone: "+34 600 001 007",
    }),
    L(8, {
      ...
      listerName: "Pol", listerEmail: "pol.reder+8@example.com", listerPhone: "+34 600 001 008",
    }),
    L(9, {
      ...
      listerName: "Marta", listerEmail: "marta.reder+9@example.com", listerPhone: "+34 600 001 009",
    }),
    L(10, {
      ...
      listerName: "Nil", listerEmail: "nil.reder+10@example.com", listerPhone: "+34 600 001 010",
    }),
    L(11, {
      ...
      listerName: "Jana", listerEmail: "jana.reder+11@example.com", listerPhone: "+34 600 001 011",
    }),
    L(12, {
      ...
      listerName: "Roger", listerEmail: "roger.reder+12@example.com", listerPhone: "+34 600 001 012",
    }),
  ];
